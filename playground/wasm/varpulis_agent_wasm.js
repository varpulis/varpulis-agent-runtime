...
export class WasmAgentRuntime {
     ...
     */
    addBudgetRunaway(config_json) {
        const ptr0 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmagentruntime_addBudgetRunaway(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     * @param {string} config_json
     */
    addCircularReasoning(config_json) {
        const ptr0 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmagentruntime_addCircularReasoning(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {string} config_json
     */
    addErrorSpiral(config_json) {
        const ptr0 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmagentruntime_addErrorSpiral(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {string} config_json
     */
    addRetryStorm(config_json) {
        const ptr0 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmagentruntime_addRetryStorm(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {string} config_json
     */
    addStuckAgent(config_json) {
        const ptr0 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmagentruntime_addStuckAgent(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {string} config_json
     */
    addTokenVelocity(config_json) {
        const ptr0 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmagentruntime_addTokenVelocity(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    eventCount() {
        const ret = wasm.wasmagentruntime_eventCount(this.__wbg_ptr);
     ...
     */
    constructor() {
        const ret = wasm.wasmagentruntime_new();
        this.__wbg_ptr = ret >>> 0;
        WasmAgentRuntimeFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    observe(event_json) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmagentruntime_observe(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     */
    reset() {
        wasm.wasmagentruntime_reset(this.__wbg_ptr);
    }
    /**
     ...
     */
    setCooldownMs(ms) {
        wasm.wasmagentruntime_setCooldownMs(this.__wbg_ptr, ms);
    }
    /**
     * Create a runtime with all default patterns.
     * @returns {WasmAgentRuntime}
     */
    static withDefaultPatterns() {
        const ret = wasm.wasmagentruntime_withDefaultPatterns();
        return WasmAgentRuntime.__wrap(ret);
    }
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./varpulis_agent_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('varpulis_agent_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
