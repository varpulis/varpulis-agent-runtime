...
export const __wbg_wasmagentruntime_free: (a: number, b: number) => void;
...
export const wasmagentruntime_eventCount: (a: number) => bigint;
export const wasmagentruntime_new: () => number;
export const wasmagentruntime_observe: (a: number, b: number, c: number) => [number, number, number, number];
export const wasmagentruntime_reset: (a: number) => void;
export const wasmagentruntime_setCooldownMs: (a: number, b: bigint) => void;
export const wasmagentruntime_withDefaultPatterns: () => number;
